...
insert  into `sys_user`(`fs_id`,`fd_create_time`,`fd_register_date`,`fd_update_time`,`fs_account`,`fs_description`,`fs_email`,`fs_image`,`fs_name`,`fs_password`,`fs_phone`,`fs_status`,`fs_type_sign`) values ('4809e79f-46ef-43ff-b39b-09a991aed8a3',NULL,NULL,NULL,'admin','超级管理员用户','1279066525@qq.com',NULL,'超级管理员','111111',NULL,'1','0');
