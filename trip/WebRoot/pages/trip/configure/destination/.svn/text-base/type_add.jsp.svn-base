...
{
	$.post("${otapp}/trip/configure/destination/judgeInput.html?json=",{"fsname":fsname,"fsSign":fsSign},
			function(data)
			{
				if(data.error!=1)
				{
			...
			<tr><td>
				...
				<table width="100%" cellpadding="0" cellspacing="0" class="table" style="width: 100%; top: 0px;"  >
					<tr>
		    			...
		    			<td width="70%"><input class="easyui-textbox" type="text" id="fsName" name="dt.fsName" data-options="required:true" style="width:350px;" ></input></td>
		    		</tr>
		    		<tr>
		    			<th  width="30%"><spring:message code="trip.manager.configure.manager.destination.type.add.fsSign" /></th>
		    			<td width="70%" ><input class="easyui-textbox" type="text" id="fsSign" name="dt.fsSign" data-options="required:true" style="width:350px;"></input></td>
		    		</tr>
		    		<tr>
