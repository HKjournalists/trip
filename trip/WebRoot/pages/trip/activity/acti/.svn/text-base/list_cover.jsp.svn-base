...
function uploadFile(){
	 $.ajaxFileUpload({ 
         ...
         data: { 
        	 'im.fsObjId': '${actId}' ,
        	 'im.fsObjTabName': 'ot_acti_info' ,
        	 'im.fsObjSign': 'trip_cover_image' 
        	 }, //此参数非常严谨，写错一个引号都不行
         secureuri       : false,  
...
<body>
	<div class="rightinfo">
		<div class="col-md-12">    
        	<div class="col-md-4">
        		<h4>
		        	<!--  <span><spring:message code="trip.manager.activity.public.view.cover.title" /></span>-->
		        	<span><spring:message code="trip.manager.activity.public.view.cover.title" />: <font color="red">${actiTitle }</font></span>
				...
				<table width="100%" cellpadding="0" cellspacing="0" class="table">
		          <tr>
		          	<th scope="row" width="20%"><spring:message code="trip.manager.activity.public.view.cover.pic.lab" /></th>
				...
				<table width="100%" cellpadding="0" cellspacing="0" class="table">
		          <tr>
		          	<th scope="row" width="20%"><spring:message code="trip.manager.activity.public.view.cover.query.fsName" /></th>
