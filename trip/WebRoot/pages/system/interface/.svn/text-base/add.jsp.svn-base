...
$(document).ready(function(){
	...
	if(statusCode!=null&&"success"==statusCode){
		...
		location.replace("${otapp}/system/interface_conf/manager.html");
	}
});
/**
 * @see 提交数据
...
<body>
	...
	<div class="rightinfo">
		<table  width="100%" cellpadding="0" cellspacing="0"  style="width: 100%; top: 0px;margin: 0px;padding: 0px;border: 0xp;">
			<tr><td>
				<h5>
		        	<span><spring:message code="system.configure.manager.interface.conf.add.title" /></span>
		        </h5>
			</td></tr>
			<tr><td>
				<form id="addForm" method="post" action="${otapp}/system/interface_conf/save.html">
				<table width="100%" cellpadding="0" cellspacing="0" class="table" style="width: 100%; top: 0px;"  >
					<tr>
		    			<th width="30%"><spring:message code="system.configure.manager.interface.conf.add.clientAccount" /></th>
		    			<td width="70%"><input class="easyui-textbox" type="text" name="wsc.fsClientAccount" data-options="required:true" style="width:350px;"></input></td>
		    		</tr>
		    		<tr>
		    			<th  width="30%"><spring:message code="system.configure.manager.interface.conf.add.clientPassword" /></th>
		    			<td width="70%" ><input class="easyui-textbox" type="text" name="wsc.fsClientPassword" data-options="required:true" style="width:350px;"></input></td>
		    		</tr>
		    		<tr>
