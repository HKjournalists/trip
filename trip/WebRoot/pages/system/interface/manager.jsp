 ...
 */
function del(id){
    $.post('${otapp}/system/interface_conf/delete.html?json',{"id":id},function(data, textStatus){  
...
<body>
	<div class="place">
		...
		<ul class="placeul">
			...
			<li><a href="#"><spring:message code="system.configure.manager.interface.conf.position.title" /></a></li>
		</ul>
	</div>
	...
	<div class="rightinfo">
		<div class="col-md-12">    
        	<div class="col-md-4">
		        <h4>
		        	<span><spring:message code="system.configure.manager.interface.conf.position.title" /></span>
		        	<ul class="toolbar1">
			        <a href="${otapp}/system/interface_conf/toAdd.html" class="easyui-linkbutton" data-options="iconCls:'icon-addExtBtn'"><spring:message code="system.configure.manager.interface.conf.btn.add" /></a>
			        &nbsp;
			        </ul>
		        </h4>
				<form action="${otapp}/system/interface_conf/manager.html" method="post" id="subform">
				<table width="100%" cellpadding="0" cellspacing="0" class="table">
		          <tr>
		            <th scope="row" width="20%"><spring:message code="system.configure.manager.interface.conf.query.clientAccount" /></th>
		            <td width="30%" colspan="1"><input name="wsc.fsClientAccount" type="text" class="scinput" value="${wsc.fsClientAccount}" /></td>
		            <th scope="row" width="20%"><spring:message code="system.configure.manager.interface.conf.query.clientPassword" /></th>
		            <td width="30%" colspan="1"><input name="wsc.fsClientPassword" type="text" class="scinput" value="${wsc.fsClientPassword}" /></td>
		          </tr>
		          <tr>
				...
				<ec:table 
					items="scList" var="sc"
					action="${otapp}/system/interface_conf/manager.html"
					...
					<ec:row>
						<ec:column property="fsClientAccount"
							title="system.configure.manager.interface.conf.clientAccount" width="45%" />
						<ec:column property="fsClientPassword" title="system.configure.manager.interface.conf.clientPassword" width="45%" >
						</ec:column>
						<ec:column property="tt" title="common.column.lab.operator" width="10%" style="align:center;" >
							...
							<a href="javascript:del('${sc.fsId}');"><spring:message code="common.button.del" /></a>
						</ec:column>
