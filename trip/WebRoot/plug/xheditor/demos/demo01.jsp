...
<script type="text/javascript" src="http://localhost:8080/hfts-org/multi-plug/xheditor/jquery/jquery-1.4.2.min.js"></script>
<script type="text/javascript" src="http://localhost:8080/hfts-org/multi-plug/xheditor/xheditor-1.1.8-zh-cn.min.js"></script>
