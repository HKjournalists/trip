 ...
 */
public class ViewDictionaryNameTag extends BodyTagSupport {
	...
	public int doEndTag() throws JspException {
        ...
        try {
        	final SysDictionaryValue value=dictionaryValueService.findSysDictionaryValueById(id);
        	out = pageContext.getOut();  
        	if(value!=null&&StringUtils.isNotBlank(value.getFsName())){
    			out.write(value.getFsName());
        	}else{
        		out.write("");
        	}
